...
let UsersService = class UsersService {
    ...
    async signUp(signUpDto) {
        ...
        const createdAuth = await this.userModel.create(Object.assign(Object.assign({}, signUpDto), { password: hash }));
    ...
    async getAllUsers() {
        return await this.userModel
            .find({ role: [role_enum_1.Roles.ADMIN, role_enum_1.Roles.BEAUTICIAN] })
            .exec();
    }
